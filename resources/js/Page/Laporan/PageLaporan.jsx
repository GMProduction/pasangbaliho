...
export class PageLaporan extends Component {
    ...
    async componentDidMount(){
        ...
        await this.props.onMounted('Laporan')
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={12} style={{marginBottom: '25px'}}>
                        <Grid container spacing={3}>
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <PanelMenu
                                    link='/dashboard/laporan/proses'
                                    color='#FC9007'
                                    icon='note_add'
                                    title='Laporan Proses Transaksi'
                                    subTitle='Laporan Proses Transaksi yang Sedang Berlangsung'
                                />
                            </Grid>
                            <Grid item xs={12} sm={12} md={6} lg={6}>
                                <PanelMenu
                                    ...
                                    subTitle='Laporan Piutang Advertiser'
                                />
                            </Grid>
                        </Grid>
                    </Grid>
