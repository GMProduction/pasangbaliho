...
import { loadPermintaan } from '../../Controller/MediaIklanControll';

export class PagePermintaanMedia extends Component {
    constructor(props) {
        super(props);
        this.state = {
                ...
                <Fade bottom>
                    <BasicPanel>
                        <BasicPanelHeader color='#9129AC'>
                            <Box flexGrow={1}>Permintaan Harga Pemasangan Iklan</Box>
                        </BasicPanelHeader>
                        <BasicPanelContent>
...
export default withStyles(breadcumbStyle)(PagePermintaanMedia);
