...
import { loadMediaPublish } from '../../Controller/MediaIklanControll';

export class PageMediaPublik extends Component {
    ...
    initData = async () => {
        ...
        let mediapublish = await loadMediaPublish();
        this.setState({
            data : mediapublish,
            dataLoading: false,
...
export default  withStyles(breadcumbStyle)(PageMediaPublik);
