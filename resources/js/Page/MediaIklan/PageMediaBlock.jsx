...
import { loadMediaBlock } from '../../Controller/MediaIklanControll';

export class PageMediaBlock extends Component {
    ...
    initData = async () => {
        ...
        let mediablock = await loadMediaBlock();
        this.setState({
            data : mediablock,
            dataLoading: false,
...
export default withStyles(breadcumbStyle)(PageMediaBlock);
