...
export class PageConfirmPayment extends Component {
    ...
    handleSave = async (cancel) =>{
        ...
        if (response.status === 'success'){
            ...
            if(cancel){
                ...
                text = 'Transaksi Anda Sudah Kami Proses, dan Silahkan Melanjutkan Ke Proses Berikut nya'
            }
    ...
    async componentDidMount () {
        ...
        await this.props.pageOnProgress(30, 'Mohon Tunnggu Sebentar Sedang Melakukan Fetch Data...')
