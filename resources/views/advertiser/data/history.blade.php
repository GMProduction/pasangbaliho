    ...
    <table class="table table-sm" >
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center" rowspan="2" style=" vertical-align: middle" >{{formatDateToSurat($d->tanggal_awal)}}</td>
                <td class="text-center" rowspan="2" style=" vertical-align: middle" >{{formatDateToSurat($d->tanggal_akhir)}}</td>
