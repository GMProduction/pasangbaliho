...
<section id="testimonial" style="min-height: 450px" style="background-color: #ddd">
    <div class="container">
        <div class="section-heading text-center"  style="background-color: #ddd">
            <div class="col-md-12 col-xs-12">
                <h1><span>Media Iklan</span> Yang Kita Miliki</h1>
                <p class="subheading">Pilih media iklan yang kamu inginkan.</p>
            </div>
