            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 block">
                    <div class="footer-block">
                        <h4>Alamat</h4>
                        <hr />
                        <p class="" style="line-height: 10px">Griya Solopos Lt. 2</p>
                        <p style="line-height: 10px"> Jl. Adisucipto 190, </p>
                        <p style="line-height: 10px"> Surakarta, Jawa Tengah,</p>
                        <p style="line-height: 10px">Indonesia</p>
