            ...
            <div class="row">
                <div class="col-md-7 col-sm-7 col-xs-7 top-header-links">
                    <ul class="contact_links">
                        <li><i class="fa fa-phone"></i><a href="#">+62 123456</a></li>
                        <li><i class="fa fa-envelope"></i><a href="#">sales@pasangbaliho.com</a></li>
                    </ul>
                </div>
                ...
                <div class="row">
                    ...
                    <div id="navbar" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <!-- #END# Notifications -->
                            @else
                            <li id="navlogin"><a href="/databaselogin">Sign In</a></li>
